...
class VisitasioptikalsController extends \BaseController {
...
/**
	...
	{
		$matchThese = ['perijinan_id' => '9','verifikasi' => 'Visitasi Selesai'];
		$orThose = ['perijinan_id' => '9','verifikasi' => 'Visitasi Gagal'];
		$orThoses = ['perijinan_id' => '9','verifikasi' => 'Proses Visitasi'];
		if(Datatable::shouldHandle())
	    {
	     	 return Datatable::collection(Pengguna::where($matchThese)->orwhere($orThose)->orwhere($orThoses)->get())
	            ...
	            ->addColumn('', function ($model) {
                    $html = '<center> <a href="'.route('admin.visitasioptikals.edit', ['visitasioptikals'=>$model->id]).'" class="btn btn-sm btn-default">Visitasi</a> ';
		...
		return View::make('visitasioptikals.index')->withTitle('Visitasi Optikal');
	...
	{
		return View::make('visitasioptikals.create')->withTitle('Tambah Visitasi');
	}
	...
	public function show($id)
	{
		...
		return View::make('visitasioptikals.show', compact('verifikasi'));
	}
	...
	public function edit($id)
	{
		...
		return View::make('visitasioptikals.edit', ['verifikasi'=>$verifikasi, 'data'=>$data])->withTitle("Verifikasi $verifikasi->nama");
	...
	public function update($id)
	{
		...
		if( $count==count($data)) {
	        ...
	        return $pdf->download($verifikasi->nama.'_visitasioptikals.pdf');
	...
	public function destroy($id)
	{
		...
		return Redirect::route('admin.visitasioptikals.index')->with('successMessage', 'User berhasil dihapus.');
    ...
    {
        return View::make('visitasioptikals.export')->withTitle('Export Data');
    }
    ...
    private function exportPdf($verifikasi)
    {
        ...
        return $pdf->download('visitasioptikals.pdf');
    }

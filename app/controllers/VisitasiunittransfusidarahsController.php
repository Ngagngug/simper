...
class VisitasiunittransfusidarahsController extends \BaseController {
	...
	{
		$matchThese = ['perijinan_id' => '16','verifikasi' => 'Visitasi Selesai'];
		$orThose = ['perijinan_id' => '16','verifikasi' => 'Visitasi Gagal'];
		$orThoses = ['perijinan_id' => '16','verifikasi' => 'Proses Visitasi'];
		if(Datatable::shouldHandle())
	    {
	     	 return Datatable::collection(Pengguna::where($matchThese)->orwhere($orThose)->orwhere($orThoses)->get())
	            ...
	            ->addColumn('', function ($model) {
                    $html = '<center> <a href="'.route('admin.visitasiunittransfusidarahs.edit', ['visitasiunittransfusidarahs'=>$model->id]).'" class="btn btn-sm btn-default">Visitasi</a> ';
	...
	{
		return View::make('visitasiunittransfusidarahs.create')->withTitle('Tambah Visitasi');
	}
	...
	public function show($id)
	{
		...
		return View::make('visitasiunittransfusidarahs.show', compact('verifikasi'));
	}
	...
	public function edit($id)
	{
		...
		return View::make('visitasiunittransfusidarahs.edit', ['verifikasi'=>$verifikasi, 'data'=>$data])->withTitle("Verifikasi $verifikasi->nama");
	...
	public function destroy($id)
	{
		...
		return Redirect::route('admin.visitasiunittransfusidarahs.index')->with('successMessage', 'User berhasil dihapus.');
    ...
    {
        return View::make('visitasiunittransfusidarahs.export')->withTitle('Export Data');
    }
    ...
    private function exportPdf($verifikasi)
    {
        ...
        return $pdf->download('visitasiunittransfusidarahs.pdf');
    }

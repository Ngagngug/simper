...
class VerifikasiapotekrakyatsController extends \BaseController {
	...
	{
		$matchThese = ['perijinan_id' => '2','verifikasi' => 'Proses Verifikasi'];
		$orThose = ['perijinan_id' => '2','verifikasi' => 'Verifikasi Belum Lengkap'];
		if(Datatable::shouldHandle())
	    {
	           return Datatable::collection(Pengguna::where($matchThese)->orwhere($orThose)->get())
	            ...
	            ->addColumn('', function ($model) {
                    $html = '<center> <a href="'.route('admin.verifikasiapotekrakyats.edit', ['verifikasiapotekrakyats'=>$model->id]).'" class="btn btn-sm btn-default">Verifikasi</a> ';
					$html .= Form::open(array('url' => route('admin.verifikasiapotekrakyats.destroy', ['verifikasiapotekrakyats'=>$model->id]), 'method'=>'delete', 'class'=>'inline js-confirm'));
	...
	{
		return View::make('verifikasiapotekrakyats.create')->withTitle('Tambah Verifikasi');
	}
	...
	public function store()
	{
		...
		return Redirect::route('admin.verifikasiapotekrakyats.index')->with("successMessage", "Berhasil menyimpan $verifikasi->verifikasi ");
	...
	public function show($id)
	{
		...
		return View::make('verifikasiapotekrakyats.show', compact('verifikasi'));
	...
	public function edit($id)
	{
		...
		return View::make('verifikasiapotekrakyats.edit', ['verifikasi'=>$verifikasi, 'data'=>$data])->withTitle("Verifikasi $verifikasi->nama");
	...
	public function destroy($id)
	{
		...
		return Redirect::route('admin.verifikasiapotekrakyats.index')->with('successMessage', 'User berhasil dihapus.');
    ...
    {
        return View::make('verifikasiapotekrakyats.export')->withTitle('Export Data');
    }
    ...
    private function exportPdf($verifikasi)
    {
        ...
        return $pdf->download('verifikasiapotekrakyats.pdf');
    }

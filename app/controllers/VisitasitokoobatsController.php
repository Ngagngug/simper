...
class VisitasitokoobatsController extends \BaseController {
	...
	{
		$matchThese = ['perijinan_id' => '10','verifikasi' => 'Visitasi Selesai'];
		$orThose = ['perijinan_id' => '10','verifikasi' => 'Visitasi Gagal'];
		$orThoses = ['perijinan_id' => '10','verifikasi' => 'Proses Visitasi'];
		if(Datatable::shouldHandle())
	    {
	     	 return Datatable::collection(Pengguna::where($matchThese)->orwhere($orThose)->orwhere($orThoses)->get())
	            ...
	            ->addColumn('', function ($model) {
                    $html = '<center> <a href="'.route('admin.visitasitokoobats.edit', ['visitasitokoobats'=>$model->id]).'" class="btn btn-sm btn-default">Visitasi</a> ';
		...
		return View::make('visitasitokoobats.index')->withTitle('Visitasi Toko Obat');
	...
	{
		return View::make('visitasitokoobats.create')->withTitle('Tambah Visitasi');
	}
	...
	public function store()
	{
		...
		return Redirect::route('admin.visitasitokoobats.index')->with("successMessage", "Berhasil menyimpan $verifikasi->verifikasi ");
	}
	...
	public function show($id)
	{
		...
		return View::make('visitasitokoobats.show', compact('verifikasi'));
	}
	...
	public function edit($id)
	{
		...
		return View::make('visitasitokoobats.edit', ['verifikasi'=>$verifikasi, 'data'=>$data])->withTitle("Verifikasi $verifikasi->nama");
	...
	public function update($id)
	{
		...
		if( $count==count($data)) {
	        ...
	        return $pdf->download($verifikasi->nama.'_visitasitokoobats.pdf');
	...
	public function destroy($id)
	{
		...
		return Redirect::route('admin.visitasitokoobats.index')->with('successMessage', 'User berhasil dihapus.');
    ...
    {
        return View::make('visitasitokoobats.export')->withTitle('Export Data');
    }
    ...
    private function exportPdf($verifikasi)
    {
        ...
        return $pdf->download('visitasitokoobats.pdf');
    }

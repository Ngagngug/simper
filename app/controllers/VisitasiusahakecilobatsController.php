...
class VisitasiusahakecilobatsController extends \BaseController {
	...
	{
		$matchThese = ['perijinan_id' => '14','verifikasi' => 'Visitasi Selesai'];
		$orThose = ['perijinan_id' => '14','verifikasi' => 'Visitasi Gagal'];
		$orThoses = ['perijinan_id' => '14','verifikasi' => 'Proses Visitasi'];
		if(Datatable::shouldHandle())
	    {
	     	 return Datatable::collection(Pengguna::where($matchThese)->orwhere($orThose)->orwhere($orThoses)->get())
	            ...
	            ->addColumn('', function ($model) {
                    $html = '<center> <a href="'.route('admin.visitasiusahakecilobats.edit', ['visitasiusahakecilobats'=>$model->id]).'" class="btn btn-sm btn-default">Visitasi</a> ';
		...
		return View::make('visitasiusahakecilobats.index')->withTitle('Visitasi Usaha Kecil Obat Tradisional');
	...
	{
		return View::make('visitasiusahakecilobats.create')->withTitle('Tambah Visitasi');
	}
	...
	public function show($id)
	{
		...
		return View::make('visitasiusahakecilobats.show', compact('verifikasi'));
	}
	...
	public function edit($id)
	{
		...
		return View::make('visitasiusahakecilobats.edit', ['verifikasi'=>$verifikasi, 'data'=>$data])->withTitle("Verifikasi $verifikasi->nama");
	...
	public function destroy($id)
	{
		...
		return Redirect::route('admin.visitasiusahakecilobats.index')->with('successMessage', 'User berhasil dihapus.');
    ...
    {
        return View::make('visitasiusahakecilobats.export')->withTitle('Export Data');
    }
    ...
    private function exportPdf($verifikasi)
    {
        ...
        return $pdf->download('visitasiusahakecilobats.pdf');
    }

...
class VisitasialatkesehatansController extends \BaseController {
	...
	{
		$matchThese = ['perijinan_id' => '11','verifikasi' => 'Visitasi Selesai'];
		$orThose = ['perijinan_id' => '11','verifikasi' => 'Visitasi Gagal'];
		$orThoses = ['perijinan_id' => '11','verifikasi' => 'Proses Visitasi'];
		if(Datatable::shouldHandle())
	    {
	     	 return Datatable::collection(Pengguna::where($matchThese)->orwhere($orThose)->orwhere($orThoses)->get())
	            ...
	            ->addColumn('', function ($model) {
                    $html = '<center> <a href="'.route('admin.visitasialatkesehatans.edit', ['visitasialatkesehatans'=>$model->id]).'" class="btn btn-sm btn-default">Visitasi</a> ';
		...
		return View::make('visitasialatkesehatans.index')->withTitle('Visitasi Alat Kesehatan');
	...
	{
		return View::make('visitasialatkesehatans.create')->withTitle('Tambah Visitasi');
	}
	...
	public function store()
	{
		...
		return Redirect::route('admin.visitasialatkesehatans.index')->with("successMessage", "Berhasil menyimpan $verifikasi->verifikasi ");
	}
	...
	public function show($id)
	{
		...
		return View::make('visitasialatkesehatans.show', compact('verifikasi'));
	}
	...
	public function edit($id)
	{
		...
		return View::make('visitasialatkesehatans.edit', ['verifikasi'=>$verifikasi, 'data'=>$data])->withTitle("Verifikasi $verifikasi->nama");
	...
	public function update($id)
	{
		...
		if( $count==count($data)) {
	        ...
	        return $pdf->download($verifikasi->nama.'_hasilvisitasialatkesehatans.pdf');
	...
	public function destroy($id)
	{
		...
		return Redirect::route('admin.visitasialatkesehatans.index')->with('successMessage', 'User berhasil dihapus.');
    ...
    {
        return View::make('visitasialatkesehatans.export')->withTitle('Export Data');
    }
    ...
    private function exportPdf($verifikasi)
    {
        ...
        return $pdf->download('visitasialatkesehatans.pdf');
    }

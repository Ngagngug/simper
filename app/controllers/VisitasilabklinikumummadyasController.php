...
class VisitasilabklinikumummadyasController extends \BaseController {
	...
	{
		$matchThese = ['perijinan_id' => '13','verifikasi' => 'Visitasi Selesai'];
		$orThose = ['perijinan_id' => '13','verifikasi' => 'Visitasi Gagal'];
		$orThoses = ['perijinan_id' => '13','verifikasi' => 'Proses Visitasi'];
		if(Datatable::shouldHandle())
	    {
	     	 return Datatable::collection(Pengguna::where($matchThese)->orwhere($orThose)->orwhere($orThoses)->get())
	            ...
	            ->addColumn('', function ($model) {
                    $html = '<center> <a href="'.route('admin.visitasilabklinikumummadyas.edit', ['visitasilabklinikumummadyas'=>$model->id]).'" class="btn btn-sm btn-default">Visitasi</a> ';
		...
		return View::make('visitasilabklinikumummadyas.index')->withTitle('Visitasi Lab Klinik Umum Madya');
	...
	{
		return View::make('visitasilabklinikumummadyas.create')->withTitle('Tambah Visitasi');
	}
	...
	public function store()
	{
		...
		return Redirect::route('admin.visitasilabklinikumummadyas.index')->with("successMessage", "Berhasil menyimpan $verifikasi->verifikasi ");
	}
	...
	public function show($id)
	{
		...
		return View::make('visitasilabklinikumummadyas.show', compact('verifikasi'));
	}
	...
	public function edit($id)
	{
		...
		return View::make('visitasilabklinikumummadyas.edit', ['verifikasi'=>$verifikasi, 'data'=>$data])->withTitle("Verifikasi $verifikasi->nama");
	...
	public function update($id)
	{
		...
		if( $count==count($data)) {
	        ...
	        return $pdf->download($verifikasi->nama.'_visitasilabklinikumummadyas.pdf');
	...
	public function destroy($id)
	{
		...
		return Redirect::route('admin.visitasilabklinikumummadyas.index')->with('successMessage', 'User berhasil dihapus.');
    ...
    {
        return View::make('visitasilabklinikumummadyas.export')->withTitle('Export Data');
    }
    ...
    private function exportPdf($verifikasi)
    {
        ...
        return $pdf->download('visitasilabklinikumummadyas.pdf');
    }

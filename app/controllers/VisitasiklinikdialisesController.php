...
class VisitasiklinikdialisesController extends \BaseController {
	...
	{
		$matchThese = ['perijinan_id' => '5','verifikasi' => 'Visitasi Selesai'];
		$orThose = ['perijinan_id' => '5','verifikasi' => 'Visitasi Gagal'];
		$orThoses = ['perijinan_id' => '5','verifikasi' => 'Proses Visitasi'];
		if(Datatable::shouldHandle())
	    {
	     	 return Datatable::collection(Pengguna::where($matchThese)->orwhere($orThose)->orwhere($orThoses)->get())
	            ...
	            ->addColumn('', function ($model) {
                    $html = '<center> <a href="'.route('admin.visitasiklinikdialises.edit', ['visitasiklinikdialises'=>$model->id]).'" class="btn btn-sm btn-default">Visitasi</a> ';
		...
		return View::make('visitasiklinikdialises.index')->withTitle('Visitasi Klinik Dialisis');
	...
	{
		return View::make('visitasiklinikdialises.create')->withTitle('Tambah Visitasi');
	}
	...
	public function store()
	{
		...
		return Redirect::route('admin.visitasiklinikdialises.index')->with("successMessage", "Berhasil menyimpan $verifikasi->verifikasi ");
	}
	...
	public function show($id)
	{
		...
		return View::make('visitasiklinikdialises.show', compact('verifikasi'));
	}
	...
	public function edit($id)
	{
		...
		return View::make('visitasiklinikdialises.edit', ['verifikasi'=>$verifikasi, 'data'=>$data])->withTitle("Verifikasi $verifikasi->nama");
	...
	public function update($id)
	{
		...
		if( $count==count($data)) {
	        ...
	        return $pdf->download($verifikasi->nama.'_visitasiklinikdialises.pdf');
	...
	public function destroy($id)
	{
		...
		return Redirect::route('admin.visitasiklinikdialises.index')->with('successMessage', 'User berhasil dihapus.');
    ...
    {
        return View::make('visitasiklinikdialises.export')->withTitle('Export Data');
    }
    ...
    private function exportPdf($verifikasi)
    {
        ...
        return $pdf->download('visitasiklinikdialises.pdf');
    }

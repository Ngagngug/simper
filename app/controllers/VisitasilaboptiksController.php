...
class VisitasilaboptiksController extends \BaseController {
	...
	{
		$matchThese = ['perijinan_id' => '8','verifikasi' => 'Visitasi Selesai'];
		$orThose = ['perijinan_id' => '8','verifikasi' => 'Visitasi Gagal'];
		$orThoses = ['perijinan_id' => '8','verifikasi' => 'Proses Visitasi'];
		if(Datatable::shouldHandle())
	    {
	     	 return Datatable::collection(Pengguna::where($matchThese)->orwhere($orThose)->orwhere($orThoses)->get())
	            ...
	            ->addColumn('', function ($model) {
                    $html = '<center> <a href="'.route('admin.visitasilaboptiks.edit', ['visitasilaboptiks'=>$model->id]).'" class="btn btn-sm btn-default">Visitasi</a> ';
		...
		return View::make('visitasilaboptiks.index')->withTitle('Visitasi Lab Optik');
	...
	{
		return View::make('visitasilaboptiks.create')->withTitle('Tambah Visitasi');
	}
	...
	public function store()
	{
		...
		return Redirect::route('admin.visitasilaboptiks.index')->with("successMessage", "Berhasil menyimpan $verifikasi->verifikasi ");
	}
	...
	public function show($id)
	{
		...
		return View::make('visitasilaboptiks.show', compact('verifikasi'));
	}
	...
	public function edit($id)
	{
		...
		return View::make('visitasilaboptiks.edit', ['verifikasi'=>$verifikasi, 'data'=>$data])->withTitle("Verifikasi $verifikasi->nama");
	...
	public function update($id)
	{
		...
		if( $count==count($data)) {
	        ...
	        return $pdf->download($verifikasi->nama.'_visitasilaboptiks.pdf');
	...
	public function destroy($id)
	{
		...
		return Redirect::route('admin.visitasilaboptiks.index')->with('successMessage', 'User berhasil dihapus.');
    ...
    {
        return View::make('visitasilaboptiks.export')->withTitle('Export Data');
    }
    ...
    private function exportPdf($verifikasi)
    {
        ...
        return $pdf->download('visitasilaboptiks.pdf');
    }

...
class VerifikasirumahsakitsController extends \BaseController {
	...
	{
		$matchThese = ['perijinan_id' => '12','verifikasi' => 'Proses Verifikasi'];
		$orThose = ['perijinan_id' => '12','verifikasi' => 'Verifikasi Belum Lengkap'];
		if(Datatable::shouldHandle())
	    {
	           return Datatable::collection(Pengguna::where($matchThese)->orwhere($orThose)->get())
	            ...
	            ->addColumn('', function ($model) {
                    $html = '<center> <a href="'.route('admin.verifikasirumahsakits.edit', ['verifikasirumahsakits'=>$model->id]).'" class="btn btn-sm btn-default">Verifikasi</a> ';
					$html .= Form::open(array('url' => route('admin.verifikasirumahsakits.destroy', ['verifikasirumahsakits'=>$model->id]), 'method'=>'delete', 'class'=>'inline js-confirm'));
		...
		return View::make('verifikasirumahsakits.index')->withTitle('Verifikasi Rumah sakit');
	}
	...
	{
		return View::make('verifikasirumahsakits.create')->withTitle('Tambah Verifikasi');
	}
	...
	public function store()
	{
		...
		return Redirect::route('admin.verifikasirumahsakits.index')->with("successMessage", "Berhasil menyimpan $verifikasi->verifikasi ");
	...
	public function show($id)
	{
		...
		return View::make('verifikasirumahsakits.show', compact('verifikasi'));
	...
	public function edit($id)
	{
		...
		return View::make('verifikasirumahsakits.edit', ['verifikasi'=>$verifikasi, 'data'=>$data])->withTitle("Verifikasi $verifikasi->nama");
	...
	public function destroy($id)
	{
		...
		return Redirect::route('admin.verifikasirumahsakits.index')->with('successMessage', 'User berhasil dihapus.');
    ...
    {
        return View::make('verifikasirumahsakits.export')->withTitle('Export Data');
    }
    ...
    private function exportPdf($verifikasi)
    {
        ...
        return $pdf->download('verifikasirumahsakits.pdf');
    }
}

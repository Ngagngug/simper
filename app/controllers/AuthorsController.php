		...
		if(Datatable::shouldHandle())
	    {
	        return Datatable::collection(Author::all(array('id','name')))
	            ...
	            ->addColumn('', function ($model) {
                    $html = '<center> <a href="'.route('admin.authors.edit', ['authors'=>$model->id]).'" class="btn btn-sm btn-default">edit</a> ';
					$html .= Form::open(array('url' => route('admin.authors.destroy', ['authors'=>$model->id]), 'method'=>'delete', 'class'=>'inline js-confirm'));

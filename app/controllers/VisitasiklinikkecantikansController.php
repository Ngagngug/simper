...
class VisitasiklinikkecantikansController extends \BaseController {
	...
	{
		$matchThese = ['perijinan_id' => '6','verifikasi' => 'Visitasi Selesai'];
		$orThose = ['perijinan_id' => '6','verifikasi' => 'Visitasi Gagal'];
		$orThoses = ['perijinan_id' => '6','verifikasi' => 'Proses Visitasi'];
		if(Datatable::shouldHandle())
	    {
	     	 return Datatable::collection(Pengguna::where($matchThese)->orwhere($orThose)->orwhere($orThoses)->get())
	            ...
	            ->addColumn('', function ($model) {
                    $html = '<center> <a href="'.route('admin.visitasiklinikkecantikans.edit', ['visitasiklinikkecantikans'=>$model->id]).'" class="btn btn-sm btn-default">Visitasi</a> ';
		...
		return View::make('visitasiklinikkecantikans.index')->withTitle('Visitasi Klinik Kecantikan');
	...
	{
		return View::make('visitasiklinikkecantikans.create')->withTitle('Tambah Visitasi');
	}
	...
	public function store()
	{
		...
		return Redirect::route('admin.visitasiklinikkecantikans.index')->with("successMessage", "Berhasil menyimpan $verifikasi->verifikasi ");
	}
	...
	public function show($id)
	{
		...
		return View::make('visitasiklinikkecantikans.show', compact('verifikasi'));
	}
	...
	public function edit($id)
	{
		...
		return View::make('visitasiklinikkecantikans.edit', ['verifikasi'=>$verifikasi, 'data'=>$data])->withTitle("Verifikasi $verifikasi->nama");
	...
	public function update($id)
	{
		...
		if( $count==count($data)) {
	        ...
	        return $pdf->download($verifikasi->nama.'_visitasiklinikkecantikans.pdf');
	...
	public function destroy($id)
	{
		...
		return Redirect::route('admin.visitasiklinikkecantikans.index')->with('successMessage', 'User berhasil dihapus.');
    ...
    {
        return View::make('visitasiklinikkecantikans.export')->withTitle('Export Data');
    }
    ...
    private function exportPdf($verifikasi)
    {
        ...
        return $pdf->download('visitasiklinikkecantikans.pdf');
    }

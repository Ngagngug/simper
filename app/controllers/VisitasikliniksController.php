...
class VisitasikliniksController extends \BaseController {
	...
	{
		$matchThese = ['perijinan_id' => '4','verifikasi' => 'Visitasi Selesai'];
		$orThose = ['perijinan_id' => '4','verifikasi' => 'Visitasi Gagal'];
		$orThoses = ['perijinan_id' => '4','verifikasi' => 'Proses Visitasi'];
		if(Datatable::shouldHandle())
	    {
	     	 return Datatable::collection(Pengguna::where($matchThese)->orwhere($orThose)->orwhere($orThoses)->get())
	            ...
	            ->addColumn('', function ($model) {
                    $html = '<center> <a href="'.route('admin.visitasikliniks.edit', ['visitasikliniks'=>$model->id]).'" class="btn btn-sm btn-default">Visitasi</a> ';
		...
		return View::make('visitasikliniks.index')->withTitle('Visitasi Klinik');
	...
	{
		return View::make('visitasikliniks.create')->withTitle('Tambah Visitasi');
	}
	...
	public function store()
	{
		...
		return Redirect::route('admin.visitasikliniks.index')->with("successMessage", "Berhasil menyimpan $verifikasi->verifikasi ");
	}
	...
	public function show($id)
	{
		...
		return View::make('visitasikliniks.show', compact('verifikasi'));
	}
	...
	public function edit($id)
	{
		...
		return View::make('visitasikliniks.edit', ['verifikasi'=>$verifikasi, 'data'=>$data])->withTitle("Verifikasi $verifikasi->nama");
	...
	public function update($id)
	{
		...
		if( $count==count($data)) {
	        ...
	        return $pdf->download($verifikasi->nama.'_visitasikliniks.pdf');
	...
	public function destroy($id)
	{
		...
		return Redirect::route('admin.visitasikliniks.index')->with('successMessage', 'User berhasil dihapus.');
    ...
    {
        return View::make('visitasikliniks.export')->withTitle('Export Data');
    }
    ...
    private function exportPdf($verifikasi)
    {
        ...
        return $pdf->download('visitasikliniks.pdf');
    }

...
@section('breadcrumb')
 <ol class="breadcrumb">
    ...
    <li><a href="{{ route('admin.visitasiunittransfusidarahs.index') }}">Visitasi Unit Transfusi Darah</a></li>
...
<div class="box box-primary">
  ...
  <h3 class="box-title">Silahkan Pilih Data :</h3>
    ...
    {{ Form::open(array('url' => route('admin.visitasiunittransfusidarahs.exportpost'), 'method' => 'post', 'class'=>'box-body')) }}

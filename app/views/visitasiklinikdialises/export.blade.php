...
@section('breadcrumb')
 <ol class="breadcrumb">
    ...
    <li><a href="{{ route('admin.visitasiklinikdialises.index') }}">Visitasi Klinik Dialisis</a></li>
...
<div class="box box-primary">
  ...
  <h3 class="box-title">Silahkan Pilih Data :</h3>
    ...
    {{ Form::open(array('url' => route('admin.visitasiklinikdialises.exportpost'), 'method' => 'post', 'class'=>'box-body')) }}

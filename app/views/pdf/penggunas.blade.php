...
<body>
    ...
    <table class="tg">
        ...
        <tbody>
            ...
            <tr>
                <td class="tg-rv4w">{{ $pengguna->nama }}</td>
                <td class="tg-rv4w">{{ $pengguna->perijinan->nama }}</td>
                <td class="tg-rv4w">{{ $pengguna->lokasi }}</td>
                <td class="tg-rv4w">{{ $pengguna->verifikasi }}</td>
                <td class="tg-rv4w">{{ $pengguna->email }}</td>
                <td class="tg-rv4w">{{ $pengguna->created_at }}</td>          
            </tr>
            @endforeach
        </tbody>
    </table>

...
@section('breadcrumb')
 <ol class="breadcrumb">
    ...
    <li><a href="{{ route('admin.verifikasilaboptiks.index') }}">Verifikasi Lab Klinik Umum Pratama</a></li>
...
<div class="box box-primary">
  ...
  <h3 class="box-title">Silahkan Pilih Data :</h3>
    ...
    {{ Form::open(array('url' => route('admin.verifikasilaboptiks.exportpost'), 'method' => 'post', 'class'=>'box-body')) }}

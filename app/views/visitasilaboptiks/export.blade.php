...
@section('breadcrumb')
 <ol class="breadcrumb">
    ...
    <li><a href="{{ route('admin.visitasilaboptiks.index') }}">Visitasi Lab Optik</a></li>
...
<div class="box box-primary">
  ...
  <h3 class="box-title">Silahkan Pilih Data :</h3>
    ...
    {{ Form::open(array('url' => route('admin.visitasilaboptiks.exportpost'), 'method' => 'post', 'class'=>'box-body')) }}

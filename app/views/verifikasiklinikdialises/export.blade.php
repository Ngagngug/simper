...
@section('breadcrumb')
 <ol class="breadcrumb">
    ...
    <li><a href="{{ route('admin.verifikasiklinikdialises.index') }}">Verifikasi Klinik Dialisis</a></li>
...
<div class="box box-primary">
  ...
  <h3 class="box-title">Silahkan Pilih Data :</h3>
    ...
    {{ Form::open(array('url' => route('admin.verifikasiklinikdialises.exportpost'), 'method' => 'post', 'class'=>'box-body')) }}

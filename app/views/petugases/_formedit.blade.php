  ...
  <h3 class="box-title">Pendaftaran Baru</h3>
    ...
    <div class="box-body">
                        ...
                        <div class="form-group">
                          ...
                          <input value="{{ $petugase->berlaku }}" name="berlaku" type="text" class="form-control" data-inputmask="'alias': 'dd-mm-yyyy'" data-mask>
                        </div><!-- /.input group -->
                        </div> 
                        ...
                        <div class="form-group">
                          ...
                          <input value="{{ $petugase->tanggallahir }}" name="tanggallahir" type="text" class="form-control" data-inputmask="'alias': 'dd-mm-yyyy'" data-mask>
                        </div><!-- /.input group -->
                        </div> 

...
@section('breadcrumb')
 <ol class="breadcrumb">
    ...
    <li><a href="{{ route('admin.verifikasirumahsakits.index') }}">Verifikasi Rumah sakit</a></li>
...
<div class="box box-primary">
  ...
  <h3 class="box-title">Silahkan Pilih Data :</h3>
    ...
    {{ Form::open(array('url' => route('admin.verifikasirumahsakits.exportpost'), 'method' => 'post', 'class'=>'box-body')) }}

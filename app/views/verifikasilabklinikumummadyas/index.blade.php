...
@section('title-button')
    <a class="btn btn-block btn-primary" href="{{ route('admin.verifikasilabklinikumummadyas.export') }}">Export</a>
@stop
...
@section('content')
   ...
   {{ Datatable::table()
    ...
    ->setUrl(route('admin.verifikasilabklinikumummadyas.index'))   // this is the route where data will be retrieved

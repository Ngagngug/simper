...
@section('breadcrumb')
 <ol class="breadcrumb">
    ...
    <li><a href="{{ route('admin.verifikasilabklinikumummadyas.index') }}">Verifikasi Lab Klinik Umum Madya</a></li>
...
<div class="box box-primary">
  ...
  <h3 class="box-title">Silahkan Pilih Data :</h3>
    ...
    {{ Form::open(array('url' => route('admin.verifikasilabklinikumummadyas.exportpost'), 'method' => 'post', 'class'=>'box-body')) }}

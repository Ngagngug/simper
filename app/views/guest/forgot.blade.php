...
@section('content')
   ...
   <div class="login-box">
    <div class="login-box-body" style="width: 500px;">
        ...
        {{ Form::open(array('url' => route('guest.sendresetcode'), 'method'=>'post', 'class' => 'box-body')) }}
          
            <div class="form-group">
                {{ Form::labelUIHorizontal('email', 'Masukan Email') }}
                {{ Form::textUI('email', 'emailmu@website.com','fa fa-at') }}
            </div>

...
@section('breadcrumb')
 <ol class="breadcrumb">
    ...
    <li><a href="{{ route('admin.visitasiusahakecilobats.index') }}">Visitasi Usaha Kecil Obat</a></li>
...
<div class="box box-primary">
  ...
  <h3 class="box-title">Silahkan Pilih Data :</h3>
    ...
    {{ Form::open(array('url' => route('admin.visitasiusahakecilobats.exportpost'), 'method' => 'post', 'class'=>'box-body')) }}
